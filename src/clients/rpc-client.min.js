...
class RpcClient {
  ...
  async call(t, e, r = void 0, i = {}) {
    const s = { jsonrpc: '2.0', method: t, id: void 0 === r ? this.#s() : r };
    null != e && (s.params = e);
    try {
      const t = await fetchFn(this.#t, {
        method: 'POST',
        headers: { ...this.#e, ...i },
      ...
      return this.deserializeBigIntsAndDates(e.result);
    } catch (t) {
      throw (console.error('RPC call failed:', t), t);
    }
  }
  async notify(t, e = {}, r = {}) {
    await this.call(t, e, null, r);
  }
  async batch(t, e = {}) {
    const r = t.map((t) => {
      const e = {
        jsonrpc: '2.0',
        method: t.method,
        id: void 0 !== t.id ? t.id : this.#s(),
      };
      return (
        void 0 !== t.params && null !== t.params && (e.params = t.params),
        e
      );
    });
    try {
      ...
      throw (console.error('Batch RPC call failed:', t), t);
    }
  }
  serializeBigIntsAndDates(t) {
    ...
    if (t && 'object' == typeof t) {
      ...
      for (const [r, i] of Object.entries(t))
        e[r] = this.serializeBigIntsAndDates(i);
      return e;
    }
    return t;
  }
...
((module.exports = RpcClient), (module.exports.RpcClient = RpcClient));
